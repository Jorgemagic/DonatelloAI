    ...
    public class TaskListPanel
    {
        ...
        public unsafe void Show(ref ImGuiIO* io)
        {
            if (this.OpenWindow)
            {
                ...
                ImguiNative.igSetNextWindowBgAlpha(0.35f);
                ImguiNative.igBegin("Task list", this.OpenWindow.Pointer(), ImGuiWindowFlags.AlwaysAutoResize | ImGuiWindowFlags.NoSavedSettings | ImGuiWindowFlags.NoFocusOnAppearing | ImGuiWindowFlags.NoNav);
